...
<div className="detailImg">
 <img src={content.poster_path!==null?`https://image.tmdb.org/t/p//w500/${content.poster_path}`:`https://media.istockphoto.com/vectors/missing-person-milk-carton-vector-id507773587?k=20&m=507773587&s=612x612&w=0&h=FRVHzYJRUigco0DK6fNgwnzX9AgdMNhgZH6Zy5phFg4=`} alt="" />
</div>
...
<div className="writer">
  <div>
    <p><span style={{fontSize:'13px'}}>Director</span> <br/> <span style={{fontWeight:'bold'}}>{director.name}</span></p> 
  </div>
  <div>
    <p> <span style={{fontSize:'13px'}}>producer</span> <br /><span style={{fontWeight:'bold'}}>{producer.name}</span> </p> 
  </div>
  <div>
    <p><span style={{fontSize:'13px'}}>Writer</span> <br/> <span style={{fontWeight:'bold'}}>{writer.name}</span> </p> 
  </div>
</div>
</div>
