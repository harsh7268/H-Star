...
export default function MainDetail(props) {
 ...
 <div style={{display:loading===true?'none':''}} >
  ...
  <CastCrew  mainFunc={mainFunc} cast={cast} crew={crew} externalId={externalId}  content={content} production={production} />
...
<iframe width="560" height="315" src={trailer} frameborder="0" allowfullscreen></iframe>   
      ...
      { type==='person' &&
        ...
        <Person iden={iden} content={content} knowsFor={knowsFor} mainFunc={mainFunc} externalId={externalId} id={id} type={type} />
