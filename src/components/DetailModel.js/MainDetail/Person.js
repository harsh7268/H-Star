...
export default function Person(props) {
    const {content,knowsFor,mainFunc,externalId,type,id,iden} = props;
  ...
  return (
    <div className='person'>
      ...
      <div className="leftSlider">
        <img src={content.profile_path!==null?`https://image.tmdb.org/t/p/original${content.profile_path}`:`https://i.pinimg.com/originals/8b/16/7a/8b167af653c2399dd93b952a48740620.jpg`} alt="" />
        ...
        <div className="leftSliderIcon">
            ...
            <a href={`https://www.instagram.com/${externalId.imdb_id}`} target="_blank">
            <FaImdb />
            </a>
        </div>
        <h2>Personal Info</h2>
        <div>
            <h4>Know For</h4>
            <span>{content.known_for_department}</span>
        </div>
        <div>
            <h4>Known Credits</h4>
        ...
        <div>
            <h4>Birthday</h4>
            <span>{content.birthday}</span>
        </div>
        <div>
            <h4>Place of Birth</h4>
            <span>{content.place_of_birth}</span>
        </div>
      ...
      { knowsFor &&
       ...
       { knowsFor &&
        ...
        <img src={c.poster_path!==null?`https://image.tmdb.org/t/p//w500/${c.poster_path}`:`https://media.istockphoto.com/vectors/missing-person-milk-carton-vector-id507773587?k=20&m=507773587&s=612x612&w=0&h=FRVHzYJRUigco0DK6fNgwnzX9AgdMNhgZH6Zy5phFg4=`} alt="" />
