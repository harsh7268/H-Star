    ...
    <div >
        ...
        <div className="card">
      {
          content && content.map((c) =>(
              <SingleCard  type={typeValid===true?c.media_type:ts} mainFunc={mainFunc} key={c.id} title={c.title} backdrop_path={c.backdrop_path  || c.profile_path} id={c.id} poster_path={c.poster_path  || c.profile_path} media_type={c.media_type} known_for={type==='person'?c.known_for:false}/>
          ))
      }
    </div>
    </InfiniteScroll>
